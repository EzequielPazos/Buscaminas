...
# IMAGENES
imagen_mina = pygame.image.load("assets/images/mine.png") # Cargando una imagen de una mina
...
imagen_bg = pygame.image.load("assets/images/buscaminas_bg.jpg")
...
imagen_explosion = pygame.image.load("assets/images/explosion.png")
imagen_tablero_explosion = pygame.transform.scale(imagen_explosion, (50, 50))
imagen_flag = pygame.image.load("assets/images/flag.png")
...
pygame.mixer.music.load("assets/sfx/musica_bg.mp3")
...
fuente = pygame.font.SysFont("Arial", 35, bold=True)
...
while corriendo == True:
    ...
    if pantalla == "Inicio":    # DENTRO DE LA PANTALLA INICIO
        ...
        fondo_puntuaciones = pygame.draw.rect(display, COLOR_AZUL_CLARO, (25, 100, 750, 475))
        ...
        datos_archivo = funciones_buscaminas.leer_archivo_csv("puntuaciones.csv")
        ...
        if len(lista_mayores) > 0:
            for indice in lista_mayores:
                #BLITEAR TEXTOS
                texto_puntuacion = fuente.render(f"{datos_archivo[indice-1]} - {datos_archivo[indice]}", True, COLOR_NEGRO)
        ...
        if ingresado:
            funciones_buscaminas.escribir_archivo_csv("puntuaciones.csv", datos_csv)
            ingresado = False
            puntaje = "0000"
            texto_usuario = ""
